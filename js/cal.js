...
(function() {
  jQuery(function() {
    var $, add_comma, countDecimals, enter_to_calculate, factor_divider, get_numbers, get_operators, has_dot, keys, none_parentheses_cal, numbers, operator, operator_counter, operators, parenthese_cal, remove_comma;
    $ = jQuery;
    ...
    parenthese_cal = function(display_val) {
      var display_val_remaining, left_value, matches, negative_index, negative_inside, parenthese_value, priority_operation, regExp, temp, temp_display_val, temp_index;
