...
(function() {
  jQuery(function() {
    var $, add_comma, countDecimals, enter_to_calculate, factor_divider, first_level_operation, get_numbers, get_operators, handle_neg_value, has_dot, is_negative, keys, mixed_level_operation, none_parentheses_cal, numbers, operator, operator_counter, operators, parenthese_cal, remove_comma, second_level_operation;
    $ = jQuery;
    ...
    mixed_level_operation = function(a, b, operator) {};
    first_level_operation = function(a, b, operator) {};
    second_level_operation = function(a, b, operator) {};
