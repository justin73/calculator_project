...
(function() {
  jQuery(function() {
    var $, countDecimals, enter_to_calculate, factor_divider, has_dot, keys, none_parentheses_cal, numbers, operator, operator_counter, operators, parenthese_cal;
    $ = jQuery;
    ...
    enter_to_calculate = function() {
      ...
      if (operators.length >= 2) {
        console.log(display_val.indexOf("("));
        console.log(display_val.indexOf(")"));
